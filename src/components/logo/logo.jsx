...
export function Logo({ sx, disabled, className, href = '/', isSingle = false, ...other }) {
  ...
  const singleLogo = (
    ...
    //   />
    // </svg>
    <img src="https://imagedelivery.net/zbd8viznFTU9Xm-HIspwjQ/b520579c-53a7-4a2a-d660-a894fd7f4700/public" alt="Brain5tormers logo" />
  );
  ...
  const fullLogo = (
    ...
    //   />
    // </svg>
    <img src="https://imagedelivery.net/zbd8viznFTU9Xm-HIspwjQ/b520579c-53a7-4a2a-d660-a894fd7f4700/public" alt="Brainstormers logo" />
  );
