...
const OPTIONS_AREA = [
  ...
  { value: 'Creativo & Medios', label: 'Creativo & Medios' },
  { value: 'Publicidad & Marketing', label: 'Publicidad & Marketing' },
  { value: 'Producción de Cine & Televisión', label: 'Producción de Cine & Televisión' },
  { value: 'Medios Digitales / Creación de Contenidos', label: 'Medios Digitales / Creación de Contenidos' },
  { value: 'Editorial / Periodismo', label: 'Editorial / Periodismo' },
  { value: 'Relaciones Públicas & Comunicación', label: 'Relaciones Públicas & Comunicación' },
  { value: 'Artes Escénicas / Música / Entretenimiento', label: 'Artes Escénicas / Música / Entretenimiento' },
  { value: 'Eventos & Entretenimiento', label: 'Eventos & Entretenimiento' },
  { value: 'Industrial & Manufactura', label: 'Industrial & Manufactura' },
  { value: 'Manufactura / Industria General', label: 'Manufactura / Industria General' },
  { value: 'Automotriz', label: 'Automotriz' },
  { value: 'Aeroespacial & Defensa', label: 'Aeroespacial & Defensa' },
  { value: 'Construcción & Ingeniería', label: 'Construcción & Ingeniería' },
  { value: 'Energía & Servicios Públicos', label: 'Energía & Servicios Públicos' },
  { value: 'Logística & Cadena de Suministro', label: 'Logística & Cadena de Suministro' },
  { value: 'Transporte', label: 'Transporte' },
  { value: 'Logística & Envíos', label: 'Logística & Envíos' },
  { value: 'Negocios & Finanzas', label: 'Negocios & Finanzas' },
  { value: 'Banca & Servicios Financieros', label: 'Banca & Servicios Financieros' },
  { value: 'Seguros', label: 'Seguros' },
  { value: 'Contabilidad & Auditoría', label: 'Contabilidad & Auditoría' },
  { value: 'Consultoría', label: 'Consultoría' },
  { value: 'Capital de Riesgo / Inversión Privada', label: 'Capital de Riesgo / Inversión Privada' },
  { value: 'Bienes Raíces (Comercial, Residencial Centros Comerciales / Malls)', label: 'Bienes Raíces (Comercial, Residencial Centros Comerciales / Malls)' },
  { value: 'Retail & Consumo', label: 'Retail & Consumo' },
  { value: 'Mayoristas & Distribución', label: 'Mayoristas & Distribución' },
  { value: 'Artículos de Lujo', label: 'Artículos de Lujo' },
  { value: 'Belleza & Cuidado Personal', label: 'Belleza & Cuidado Personal' },
  { value: 'Alimentos & Bebidas (incluye Restaurantes)', label: 'Alimentos & Bebidas (incluye Restaurantes)' },
  { value: 'Salud / Hospitales', label: 'Salud / Hospitales' },
  { value: 'Industria Farmacéutica', label: 'Industria Farmacéutica' },
  { value: 'Biotecnología', label: 'Biotecnología' },
  { value: 'Bienestar & Fitness', label: 'Bienestar & Fitness' },
  { value: 'Salud Mental', label: 'Salud Mental' },
  { value: 'Servicios Legales & Profesionales', label: 'Servicios Legales & Profesionales' },
  { value: 'Servicios Jurídicos / Abogacía', label: 'Servicios Jurídicos / Abogacía' },
  { value: 'Recursos Humanos & Reclutamiento', label: 'Recursos Humanos & Reclutamiento' },
  { value: 'Capacitación & Coaching', label: 'Capacitación & Coaching' },
  { value: 'Consultoría de Negocios', label: 'Consultoría de Negocios' },
  { value: 'Tecnología & Digital', label: 'Tecnología & Digital' },

  { value: "Tecnología de la Información (TI)", label: "Tecnología de la Información (TI)" },
  { value: "Software & SaaS", label: "Software & SaaS" },
  { value: "Comercio Electrónico (E-commerce)", label: "Comercio Electrónico (E-commerce)" },
  { value: "Inteligencia Artificial & Machine Learning", label: "Inteligencia Artificial & Machine Learning" },
  { value: "Ciberseguridad", label: "Ciberseguridad" },
  { value: "Videojuegos / Industria Gaming / eSports", label: "Videojuegos / Industria Gaming / eSports" },
  { value: "Cripto & Blockchain", label: "Cripto & Blockchain" },
  { value: "Metaverso / Realidad Virtual", label: "Metaverso / Realidad Virtual" },
  { value: "Turismo, Gastronomía & Hospitalidad", label: "Turismo, Gastronomía & Hospitalidad" },
  { value: "Gastronomía", label: "Gastronomía" },
  { value: "Turismo & Viajes", label: "Turismo & Viajes" },
  { value: "Aerolíneas / Aviación", label: "Aerolíneas / Aviación" },
  { value: "Hoteles & Resorts", label: "Hoteles & Resorts" },
  { value: "Alimentos & Bebidas / Restaurantes", label: "Alimentos & Bebidas / Restaurantes" },
  { value: "Eventos & Entretenimiento", label: "Eventos & Entretenimiento" }
];
