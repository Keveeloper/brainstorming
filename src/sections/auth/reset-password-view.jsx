                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography
                                variant="h5" // Ajusta el 'variant' según el tamaño que desees, text-3xl es aprox h5/h4
                                component="h2" // Renderiza como h2 HTML
                                sx={{
                            ...
                            <Typography
                                variant="body1" // Ajusta el 'variant'
                        ...
                        >
                            ...
                            <Box
                                sx={{
                                    padding: '16px', // p-4
                                    paddingRight: '20px', // pr-5 (5 * 4px = 20px)
                                    position: 'absolute',
                                    width: '100%',
                                    height: '45%', // h-[45%]
                                    bottom: 0, // bottom-0
